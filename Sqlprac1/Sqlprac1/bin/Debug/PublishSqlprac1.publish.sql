/*
Script de implementación para DBPract1
...
GO
:setvar DatabaseName "DBPract1"
:setvar DefaultFilePrefix "DBPract1"
:setvar DefaultDataPath "C:\Users\Administrador\AppData\Local\Microsoft\Microsoft SQL Server Local DB\Instances\MSSQLLocalDB\"
:setvar DefaultLogPath "C:\Users\Administrador\AppData\Local\Microsoft\Microsoft SQL Server Local DB\Instances\MSSQLLocalDB\"
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'a2f14a56-cb46-45db-9d48-34afbda2a0d3')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('a2f14a56-cb46-45db-9d48-34afbda2a0d3')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '690c0690-355d-47ad-9830-b92105e5a7f0')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('690c0690-355d-47ad-9830-b92105e5a7f0')
